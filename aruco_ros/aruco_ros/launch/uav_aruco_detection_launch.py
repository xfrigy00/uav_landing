    ...
    return LaunchDescription([
        ...
        ExecuteProcess(
            cmd=[
                ...
                'tmux select-pane -t 0; '  # Select pane 0 (image_subscriber)
                'tmux send-keys -t my_session2: "ros2 launch aruco_ros marker_publisher.launch.py" C-m; '
                'tmux select-pane -t 1; '
                'tmux send-keys -t my_session2: "ros2 run aruco_ros marker_subscriber" C-m; '
